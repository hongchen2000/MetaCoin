...
{
    const char* pszTimestamp = "Creating Metacoin on 28/Nov/2021 . Meta needs to change more than just its name";
    const CScript genesisOutputScript = CScript() << ParseHex("151295821fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
*/
        ...
        genesis = CreateGenesisBlock(1638122336, 2001837297, 0x1e0ffff0, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x49db575f15af972a79efac1e8ace3a5c5ca0bbd40e768e7a9c171179aa63c401"));
        assert(genesis.hashMerkleRoot == uint256S("0xe38302177a78b907743baddfcc4625c92d63a9253b86d5a43693a7dd163416a2"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("s0.go-metacoin.com", "s0.go-metacoin.com", true));
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
//        vSeeds.push_back(CDNSSeedData("metacointools.com", "dnsseed.metacointools.com"));
//        vSeeds.push_back(CDNSSeedData("metacoinpool.org", "dnsseed.metacoinpool.org"));
//        vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x49db575f15af972a79efac1e8ace3a5c5ca0bbd40e768e7a9c171179aa63c401"))
...
//            (721000, uint256S("0x198a7b4de1df9478e2463bd99d75b714eab235a2e63e741641dc8a759a9840e5"))
        ...
        chainTxData = ChainTxData{
            ...
            1638122336, // * UNIX timestamp of last known number of transactions
...
*/
        ...
        genesis = CreateGenesisBlock(1638122336, 143090, 0x1e0ffff0, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1e87c106b06599fa510bfaece1dcec8786ec7fcf94aa325d2a5b4d1449a01550"));
        assert(genesis.hashMerkleRoot == uint256S("0xe38302177a78b907743baddfcc4625c92d63a9253b86d5a43693a7dd163416a2"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("s0.go-metacoin.com", "s0.go-metacoin.com"));
//        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.metacoin.loshan.co.uk", true));
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x1e87c106b06599fa510bfaece1dcec8786ec7fcf94aa325d2a5b4d1449a01550")),
        };
...
//        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1638122336, 0, 0x207fffff, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xead0edc4381ecaaec02b0bbac0c66e759e8b7e61160170cac79f48df2737c49b"));
        assert(genesis.hashMerkleRoot == uint256S("0xe38302177a78b907743baddfcc4625c92d63a9253b86d5a43693a7dd163416a2"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xead0edc4381ecaaec02b0bbac0c66e759e8b7e61160170cac79f48df2737c49b"))
        };
