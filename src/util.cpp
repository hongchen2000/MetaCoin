...
const char * const BITCOIN_CONF_FILENAME = "metacoin.conf";
const char * const BITCOIN_PID_FILENAME = "metacoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Metacoin";
#else
    // Unix
