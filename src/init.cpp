...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/metacoin-project/metacoin>";
    const std::string URL_WEBSITE = "<https://metacoin.org>";
