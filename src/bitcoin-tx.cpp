...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s metacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  metacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded metacoin transaction") + "\n" +
              "  metacoin-tx [options] -create [commands]   " + _("Create hex-encoded metacoin transaction") + "\n" +
              "\n";
